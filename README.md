...
make site     # 公開一式を _site/ へ生成
```

oer-kit は `~/Projects/oer-kit`（Makefile の既定）。pip インストール済みなら `OER_KIT=` の空指定で上書きできる。
収集パイプライン等の全コマンドは [oer-kit の docs/commands.md](https://github.com/takedatoshiyuki/oer-kit/blob/main/docs/commands.md)、
手順の全体像は [docs/user-guide.md](https://github.com/takedatoshiyuki/oer-kit/blob/main/docs/user-guide.md) を参照。

## 運用方針の要点

- 運用モードは **aggregator**（[設計書 §9.1](https://github.com/takedatoshiyuki/oer-kit/blob/main/docs/design.md)）:
